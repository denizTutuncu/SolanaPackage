...
public struct WalletDetailView: View {
    ...
    public init(publicKey: String,
                ...
                transactionListHeaderTitleTextColor: Color,
                transactionListSubtitle: String,
                transactionListHeadersubtitleTextColor: Color,
        ...
        self.transactionListHeaderTitleTextColor = transactionListHeaderTitleTextColor
        self.transactionListSubtitle = transactionListSubtitle
        self.transactionListHeadersubtitleTextColor = transactionListHeadersubtitleTextColor
    ...
    private let transactionListHeaderTitleTextColor: Color
    private let transactionListSubtitle: String
    private let transactionListHeadersubtitleTextColor: Color
    ...
    public var body: some View {
        VStack {
            ...
            TransactionListView(headerTitle: transactionListTitle,
                                headerTitleTextColor: transactionListHeaderTitleTextColor,
                                headerSubtitle: transactionListSubtitle,
                                headerSubtitleTextColor: transactionListHeadersubtitleTextColor,
                                loadingTitle: transactionLoadingTitle,
                                errorMessage: transactionErrorMessage,
                                errorViewButtonTitle: transactionErrorButtonTitle,
                                loadAgain: { transactionListViewModel.setLoading() },
    ...
    static var previews: some View {
        Group {
            WalletTestView()
                ...
                .previewDisplayName("Wallet Detail Test View")
        }
    }
}
    ...
    var body: some View {
        VStack {
            WalletDetailView(publicKey: "CwdjgD54hgTQChspxHhirWLQWqy3EsxtndrcpLBqpump",
                             ...
                             tryLoadTransactions: { },
                             balanceViewModel: .init(model: PresentableBalance(value: "10000000000.000")),
