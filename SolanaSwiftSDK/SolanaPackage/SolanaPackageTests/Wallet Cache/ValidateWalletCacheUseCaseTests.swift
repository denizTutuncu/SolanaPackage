//
//  ValidateWalletCacheUseCaseTests.swift
//  SolanaPackageTests
//
...
class ValidateWalletCacheUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalWalletLoader, toCompleteWith expectedResult: Result<Void, Error>, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        action()
